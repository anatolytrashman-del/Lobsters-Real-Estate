...
// ненадёжно, см. историю с банками в docs/session-journal.md, а по готовым структурным
...
// docs/session-journal.md) показало не баг импорта, а то, что синк никогда не проверял,
