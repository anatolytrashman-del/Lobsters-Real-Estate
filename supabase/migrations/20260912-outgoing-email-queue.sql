...
--
-- ПРИМЕНЕНО к проду 2026-09-12, после того как владелец обновил тариф Resend:
-- сначала этот файл, затем деплой Edge Function process-outgoing-emails,
-- затем крон (вторая часть файла, ниже), затем фронт мерджем в oodobu.
...
-- Выполнено 2026-09-12 (cron.job, jobid 3). Оставлено закомментированным,
