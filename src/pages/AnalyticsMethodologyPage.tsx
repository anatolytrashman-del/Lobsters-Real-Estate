      ...
      <main className="mx-auto flex max-w-3xl flex-col gap-6 px-4 py-12 sm:px-8">
        ...
        <div className={cn('flex flex-col gap-5 p-6 text-sm leading-relaxed text-ink', glassCardClass)} style={glassCardShadow}>
          <section className="flex flex-col gap-2">
            ...
            <p>
              Четыре сегмента. <strong>Офисы в бизнес-центрах Минска</strong> (аренда и продажа) — 143 здания из
              нашего каталога бизнес-центров, каждое объявление привязано к конкретному зданию по адресу. В само
              здание могут сдавать не только офисы (магазин на первом этаже, сфера услуг, кладовые) — в медиану
              сегмента идут только объявления с типом помещения «Офисы», остальные исключены на этапе расчёта
              ...
              на крыше). Остальные сегменты рынка (офисы вне бизнес-центров, первичный рынок, готовый арендный
              бизнес) пока не собираются.
            </p>
          </section>
          ...
          <section className="flex flex-col gap-2">
            ...
            <p>
              ...
              классам A/B от «Твоей столицы» (годовой отчёт, не тот же ежемесячный мониторинг, что у офисов).
            </p>
            <p>
              Отдельно на{' '}
          ...
          <section className="flex flex-col gap-2">
            ...
            <p>
              ...
              и типу сделки объявления с обеих площадок считаются один раз, оставляем найденное первым. У машиномест
              вопрос дедупликации между площадками не стоит — источник только один (Kufar).
            </p>
          </section>
          ...
          <section className="flex flex-col gap-2">
            ...
            <p>
              ...
              отдельно стоящее и т.п.; для складов — только административный район; для машиномест — административный
