      ...
      <main className="mx-auto flex max-w-3xl flex-col gap-6 px-4 py-12 sm:px-8">
        ...
        <div className={cn('flex flex-col gap-5 p-6 text-sm leading-relaxed text-ink', glassCardClass)} style={glassCardShadow}>
          <section className="flex flex-col gap-2">
            ...
            <p>
              Два сегмента. <strong>Офисы в бизнес-центрах Минска</strong> (аренда и продажа) — 143 здания из
              ...
              собственных полей площадок. Остальные сегменты рынка (склады, офисы вне бизнес-центров, первичный
              рынок, готовый арендный бизнес) пока не собираются.
            </p>
          </section>
          ...
          <section className="flex flex-col gap-2">
            ...
            <p>
              ...
              каждого здания из каталога бизнес-центров. Для торговых помещений — по всему городу, категория
              «Магазины, торговые помещения» на обеих площадках. Собираются автоматически раз в месяц.
            </p>
          </section>
          ...
          <section className="flex flex-col gap-2">
            ...
            <p>
              ...
              помещений дедупликация есть (сделана при сборе): совпадающие по улице, дому, площади, этажу и типу
              сделки объявления с обеих площадок считаются один раз, оставляем найденное первым.
            </p>
          </section>
          ...
          <section className="flex flex-col gap-2">
            ...
            <p>
              ...
              отдельно стоящее и т.п.) — медиана и 25-й/75-й перцентили цены за м² по объявлениям с указанной ценой.
