...
const TOPICS: Record<MinskMirTopicSlug, TopicContent> = {
  ...
  'kupit-ofis': {
    title: 'Купить офис в Минск Мире — цены за м², первичка и вторичка, кабинеты в Red One',
    description:
  ...
  'arenda-ofisa': {
    title: 'Аренда офиса в Минск Мире — ставки за м², что сдаётся и альтернатива аренде',
    description:
  ...
  'kommercheskie-pomeshcheniya': {
    title: 'Коммерческие помещения в Минск Мире — форматы, цены продажи и аренды за м²',
    description:
